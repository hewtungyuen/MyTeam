<template>
  <div>
    ...
    <div class="template">
      ...
      <div v-if="!this.allProjects">
        No tasks have been assigned to any members yet.
      </div>
      <div v-else class="grid">
        <div
          v-for="project in Object.keys(this.allProjects)"
          :key="project"
          style="
            display: flex;
            align-items: center;
        ...
        >
          ...
          >
            <div style="text-align: center">
              ...
              />
              <ProgressCircle
                :completed="this.allProjects[project].completed"
                :inProgress="this.allProjects[project].inProgress"
                :overdue="this.allProjects[project].overdue"
              />
            </div>
            <!-- </n-card> -->
          </n-card>
